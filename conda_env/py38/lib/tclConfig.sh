...
# installed.
TCL_PREFIX='/home/jupyter/conda_env/py38'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/jupyter/conda_env/py38'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/jupyter/conda_env/py38/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1699201809505/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/home/jupyter/conda_env/py38=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/jupyter/conda_env/py38/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/home/jupyter/conda_env/py38/lib -Wl,-rpath-link,/home/jupyter/conda_env/py38/lib -L/home/jupyter/conda_env/py38/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/jupyter/conda_env/py38/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/jupyter/conda_env/py38/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/jupyter/conda_env/py38/include'
...
# compiled.
TCL_SRC_DIR='/home/jupyter/conda_env/py38/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/jupyter/conda_env/py38/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/jupyter/conda_env/py38/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/jupyter/conda_env/py38/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/jupyter/conda_env/py38/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/jupyter/conda_env/py38/lib/libtclstub8.6.a'
