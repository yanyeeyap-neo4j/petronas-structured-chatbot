...
st.markdown("""
    ...
    <div style='text-align: center; font-size: 2.5rem; font-weight: 600; font-family: "Roboto"; color: #018BFF; line-height:1; '>PETRONAS Employee and Training Chatbot</div>
...
<table>
  ...
  <tr>
    ...
    <td>Who is Dheepa?</td>
    <td>What are the informations about Dheepa?</td>
  </tr>
  <tr>
    <td>Who has taken the Project Management program?</td>
    <td>How many employees joined the company before 2020?</td>
    <td>Who reports to Bryan Foley?</td>
  </tr>
  <tr>
    <td>Who are the full-time workers?</td>
    <td>How many training programs are there?</td>
  </tr>
</table>
""", unsafe_allow_html=True)
